...
/* flow */
router.get(interface_1.prefix + interface_1.Interface.ready, controller.flow.ready);
router.get(interface_1.prefix + interface_1.Interface.endRound, controller.flow.endRound);
router.get(interface_1.prefix + interface_1.Interface.reconnect, controller.flow.reconnect);
// Village
...
/* card */
router.get(interface_1.prefix + interface_1.Interface.drawCard, controller.player.drawCard);
